...
export default function WazeButton() {
  return (
    <a
      ...
      className="inline-flex items-center gap-2 mt-2 px-4 py-2 rounded-xl border border-gold/20 hover:border-gold/50 active:scale-95 transition-all text-xs font-sans text-charcoal/60 hover:text-charcoal touch-manipulation select-none"
    >
